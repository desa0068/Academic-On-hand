<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IncrementAll.aspx.cs" Inherits="IncrementAll" %>
...
<head runat="server">
    <title></title>
    <link rel="Stylesheet" type="text/css" href="IncrementSemester.css" />
    <style type="text/css">
        .style1
        {
            font-size: medium;
            ...
            <div id="main">
                ...
                <div id="content">
                    ...
                    <div class="box">
                        ...
                        <div class="box-head">
                            <h2 class="left">
                                Update Semester Details</h2>
                        </div>
                        <!-- End Box Head -->
                        <form id="Form1" class="contact_form" runat="server">
                        <ul id="Ul1" class="contact_form" runat="server">
                            
                          <asp:Panel runat="server" Height="187px">
                           <br />
                           
                              <li class="contact_form">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                  <asp:Label runat="server"> Are Your Sure You Want to Increment All Student&#39;s Semester?</asp:Label>
                             <br />
                             <br />
                                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button
                                    ID="Button1" runat="server" OnClick="Button1_Click" Text="   Yes" BackColor="#99FF66"
                                    Font-Size="Large" Height="35px" Width="174px" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="btnClear" runat="server" BackColor="#99FF66" Font-Size="Large" 
                                    Height="35px" OnClick="btnClear_Click" Text="Back" Width="177px" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </li>
                     </asp:Panel>
