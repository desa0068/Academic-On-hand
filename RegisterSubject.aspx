<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterSubject.aspx.cs"
    Inherits="RegisterSubject" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <link rel="Stylesheet" type="text/css" href="RegisterSubject.css" />
    <style type="text/css">
        .style1
        {
            font-size: medium;
                    ...
                    <div class="box">
                        ...
                        <ul id="Ul1" class="contact_form" runat="server">
                            ...
                            <li id="Li2" class="contact_form" runat="server">
                                <label for="id">
                                    Enter id:</label>
                                <input type="text" required runat="server" id="txtsub_id" />
                            </li>
                            <li id="Li3" class="contact_form" runat="server">
                                <label for="subname">
                                    Enter Subject Name:</label>
                                <input type="text" name="subname" required runat="server" id="txtsub_name" />
                                <span class="form_hint">Enter character only"</span> </li>
                            <li id="Li4" class="contact_form" runat="server">
                                <label for="course_id">
                                    Enter Course Id:</label>
                                <input type="text" name="courseid" required runat="server" id="txtsub_courseid" />
                                <span class="form_hint">Enter character only</span> </li>
                            <li id="Li5" class="contact_form" runat="server">
                                <label for="sem">
                                    Enter Semester:</label>
                                <input type="text" name="sem" required runat="server" id="txtsub_sem" />
                                <span class="form_hint">Enter character only</span> </li>
                            <li id="Li6" class="contact_form" runat="server">
                                <label for="sem">
                                    Enter Type:</label>
                                <input type="text" name="type" required runat="server" id="type" />
                                <span class="form_hint">Enter character only</span> </li>
                                <li id="Li7" class="contact_form" runat="server">
                                <label for="credit">
                                    Enter Credit:</label>
                                <input type="text" name="credit" required runat="server" id="credit" />
                                <span class="form_hint">Enter character only</span> </li>
