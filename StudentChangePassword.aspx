<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentChangePassword.aspx.cs" Inherits="StudentChangePassword" %>
...
<head runat="server">
    <title></title>
    <link rel="Stylesheet" type="text/css" href="StudentChangePasswordCss.css" />
    <style type="text/css">
        .style1
        {
            font-size: medium;
                     ...
                     <div class="box-head">
                        ...
                        <ul id="Ul1" class="contact_form" runat="server">
                            ...
                            <li id="Li2" class="contact_form" runat="server">
                             ...
                             <input type="password" name="newpwd" required id="txtstudpwd" runat="server" />   
                            </li>
                            <li id="Li4" class="contact_form" runat="server">
                                <label id="Label3" for="password" runat="server">
                                    Enter Confirm Password:</label>&nbsp; &nbsp;&nbsp;
                             <input type="password" name="confirmpwd" required id="txtstudconfirmpwd" runat="server" />   
                            </li>
                            <li class="contact_form">&nbsp;&nbsp;&nbsp;<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<asp:Button
                                ID="Button1" runat="server" OnClick="Button1_Click" Text="   Reset" BackColor="#99FF66"
                                Font-Size="Large" Height="35px" Width="174px" />
                                &nbsp;&nbsp; <asp:Button
                                    ID="btnClear" runat="server" OnClick="btnClear_Click" Text="Cancel" BackColor="#99FF66"
