<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateFaculty.aspx.cs" Inherits="UpdateFaculty" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title></title>
    <link rel="Stylesheet" type="text/css" href="UpdateFacultyCss.css" media="all" />
    <style type="text/css">
        .style1
        {
            font-size: medium;
                    ...
                    <div class="box">
                        ...
                        <ul id="Ul1" class="contact_form" runat="server">
                            ...
                            <li id="Li3" class="contact_form" runat="server">
                                ...
                                <input type="text" name="first_name" required id="txtfac_fname" runat="server" />
                            </li>
                            <li id="Li4" class="contact_form" runat="server">
                                <label for="middle_name">
                                    Enter Middle Name:</label>&nbsp;
                                <input type="text" name="middle_name" required id="txtfac_mname" runat="server" />
                            ...
                            <li id="Li5" class="contact_form" runat="server">
                                ...
                                <input type="text" name="last_name" required id="txtfac_lname" runat="server" />
                                <span class="form_hint">*Please enter your last name</span> </li>
                            <li class="contact_form">
                                <label for="faculty_cont_no">
                                    Enter Faculty Contact No:</label>&nbsp;
                                <input type="text" name="fac_cont_no" required id="txtfac_contno" runat="server" />
                                <span class="form_hint">Please enter contact number in numeric form</span> </li>
                            <li class="contact_form">
                                <label for="password">
                                    Enter Password:</label>&nbsp;
                                <input type="text" name="password" required id="txtfac_password" runat="server" />
                                <span class="form_hint">Please enter password</span> </li>
                            <li class="contact_form">
                                <label for="role">
                                    Enter Role:</label>&nbsp;
                                <input type="text" name="batch" required id="txtfac_role" runat="server" />
                                <span class="form_hint">Please enter role</span> </li>
