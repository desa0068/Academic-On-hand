...
public partial class ViewSubjectDetails : System.Web.UI.Page
{
    ...
    {
        cmd1 = new OdbcCommand("select * from subject_detail where course_id=(select course_id from course_detail where course_name='" + course_name.SelectedItem.Value + "')", connection);
